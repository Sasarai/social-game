...
@Component({
    selector: 'jhi-vote-sg',
    templateUrl: './vote-sg.component.html'
})
export class VoteSgComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/vote-sg'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: VoteSg) {
        return item.id;
    }
